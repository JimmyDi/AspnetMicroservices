...
namespace Basket.API.Controllers
{
    ...
    public class BasketController : ControllerBase
    {
        ...
        {
            // TODO： Communitate with Discount.Grpc, and Calculate latest prices of product into shopping cart
        ...
        public async Task<IActionResult> Checkout([FromBody] BasketCheckout basketCheckout)
        {
            ...
            // Create basketCheckoutEvent -- Set total price on basket checkout event message
